...
var Vehicles = /** @class */ (function () {
    function Vehicles(name, image, description) {
        this.name = name;
        this.image = image;
...
var Moreinfo = /** @class */ (function (_super) {
    ...
    function Moreinfo(name, image, description, seats, kilometers, age) {
        var _this = _super.call(this, name, image, description) || this;
        _this.seats = seats;
        _this.kilometers = kilometers;
        _this.age = age;
        return _this;
    }
    Moreinfo.prototype.calculatePrice = function () {
